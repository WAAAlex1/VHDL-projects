...
set_property PACKAGE_PIN U2 [get_ports {ano[1]}]					
set_property PACKAGE_PIN U4 [get_ports {ano[2]}]					
set_property PACKAGE_PIN V4 [get_ports {ano[3]}]					
set_property PACKAGE_PIN W4 [get_ports {ano[4]}]					
